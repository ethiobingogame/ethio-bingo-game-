...
def callback_query(call):
    ...
    if call.data.startswith("play_"):
        ...
        bot.send_message(
            ...
            "ብር ከላኩ በኋላ የትራንዛክሽን ማረጋገጫ (Screenshot ឬ Receipt) እዚህ ይላኩ። አድሚኑ አረጋግጦ ወደ ባላንስዎ ይጨምራል!",
            parse_mode='HTML'
        )
...
def webhook():
    bot.remove_webhook()
    # Railway የሚሰጠውን ትክክለኛ ዶሜይን እዚህ ያስገቡ (ለምሳሌ: https://ethio-bingo-game-production.up.railway.app)
    app_url = os.getenv('RAILWAY_STATIC_URL', 'ethio-bingo-game-production.up.railway.app')
